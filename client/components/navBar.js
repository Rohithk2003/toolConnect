...
export function ProfileComponent({ username, usertype }) {
  return (
    <div className="flex justify-end  w-1/4 ml-32 ">
      ...
      <div className="dropdown flex align-bottom float-right overflow-hidden">
        ...
        <div className="rounded dropdown-content hidden h-40 absolute dark:bg-gray-700 w-44 shadow-amber-950 grid-rows-3 mr-2 mt-10 right-1 dark:text-white min-w-fit z-40">
          <ul
...
export default function NavBar() {
  ...
  return (
    <>
      ...
      <div
        className={`w-full bg-black text-white flex justify-between }opacity-100 md:opacity-0 p-3 md:hidden`}
      >
        ...
        <div
          className={`bg-black text-white h-full w-full absolute top-0 block left-0 rounded overflow-hidden z-40 ease-in-out md:hidden duration-300 ${
            sidebarvisible ? "translate-x-0" : "w-0"
          }`}
        >
          ...
          <div className={`w-full flex p-4 ease-in-out  duration-300 `}>
            <Link href="/">
              <span className="material-symbols-outlined  pl-0 ml-0 h-auto align-baseline pr-3">
                handyman
              </span>
            </Link>
