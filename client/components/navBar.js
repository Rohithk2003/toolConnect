...
export function BtnDisplayComponent({onclickhandler}) {
    return (
        <div className="w-44 h-0 flex-grow flex text-Inter flex-row-reverse ">
            <UserButton text="Login" href="/login" onclickhandler={onclickhandler}/>
            <UserButton
        ...
        <div className="flex justify-end  w-1/4 ml-28 ">
            <div className="relative mt-2 mr-5 ">
                <Link href="/orderhistory">
                    ...
                    >
                        <path
                            d="M4 1L1 5V19C1 19.5304 1.21071 20.0391 1.58579 20.4142C1.96086 20.7893 2.46957 21 3 21H17C17.5304 21 18.0391 20.7893 18.4142 20.4142C18.7893 20.0391 19 19.5304 19 19V5L16 1H4Z"></path>
                        <path d="M1 5H19"></path>
                        <path
                            d="M14 9C14 10.0609 13.5786 11.0783 12.8284 11.8284C12.0783 12.5786 11.0609 13 10 13C8.93913 13 7.92172 12.5786 7.17157 11.8284C6.42143 11.0783 6 10.0609 6 9"></path>
                    </svg>
                </Link>
            </div>
            <div className="dropdown flex align-bottom float-right overflow-hidden">
                <button
                    className="flex text-center transition items-center duration-300 dropbtn hover:text-gray-500 dark:bg-black">
                    {username}
                    <svg
                        className="w-4 h-4 "
                        aria-hidden="true"
                ...
                <div
                    className="rounded dropdown-content hidden h-auto absolute dark:bg-gray-700 w-44 shadow-amber-950  mr-4 mt-10 right-1 dark:text-white min-w-fit z-40">
                    <ul
        ...
        <>
            ...
            <span className="material-symbols-outlined  pl-0 ml-0 h-auto hover:opacity-50 ease-in-out transition-opacity align-baseline pt-1 pr-8">
              handyman
                ...
                {check ? (
                    <ProfileComponent username={username} usertype={typeofuser}/>
                ) : (
                    <BtnDisplayComponent/>
                )}
            </nav>
                                ...
                                Profile_options.map((option, index) => {
                                    {
                                        ...
                                        (typeofuser !== "Seller" &&
                                            ...
                                            <div key={option.text} className=" pl-1">
                                                <NavItem {...option} />
                                            </div>
                                        );
                                    }
